...
- настройка контекста
- автоопределение параметров системы (для macOS возвращается человекочитаемое имя, например `macOS 26.x`, а не `Darwin`)
- сравнение до 3 моделей
- история последних проверок с явными полями: `контекст N токенов`, `RAM`, `VRAM`
